...
HeliumFrame::HeliumFrame(const wxString& title)
  ...
  m_backButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnBack, this);
  m_forwardButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnForward, this);
  m_homeButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnHome, this);
  m_reloadButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnReload, this);
  m_searchButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnSearch, this);
  m_newTabButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnNewTab, this);
  m_closeTabButton->Bind(wxEVT_BUTTON, &HeliumFrame::OnCloseTab, this);
  m_searchCtrl->Bind(wxEVT_TEXT_ENTER, &HeliumFrame::OnSearch, this);
  ...
  Bind(wxEVT_MENU, &HeliumFrame::OnToggleTheme, this,
  ...
  Bind(wxEVT_MENU, &HeliumFrame::OnForward, this, wxID_FORWARD);
  Bind(wxEVT_MENU, &HeliumFrame::OnBack, this, wxID_BACKWARD);
  Bind(wxEVT_MENU, &HeliumFrame::OnReload, this, wxID_REFRESH);
  Bind(wxEVT_MENU, &HeliumFrame::OnNewTab, this, wxID_NEW);
  Bind(wxEVT_MENU, &HeliumFrame::OnCloseTab, this, wxID_CLOSE);
  Bind(wxEVT_MENU, &HeliumFrame::FullScreenToggle, this,
  ...
  Bind(wxEVT_MENU, &HeliumFrame::OnQuit, this, wxID_EXIT);
