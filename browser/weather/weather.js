        ...
        $.getJSON('http://ip-api.com/json', (locationData) => {
            ...
            $.ajax({
                ...
                success: (weatherData) => {
                    ...
                    const temperature = Math.round((_b = (_a = weatherData.main) === null || _a === void 0 ? void 0 : _a.temp) !== null && _b !== void 0 ? _b : 0);
                    const weatherCode = (_e = (_d = (_c = weatherData.weather) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.id) !== null && _e !== void 0 ? _e : 0;
                    const humidity = (_g = (_f = weatherData.main) === null || _f === void 0 ? void 0 : _f.humidity) !== null && _g !== void 0 ? _g : 0;
