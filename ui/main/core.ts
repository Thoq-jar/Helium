...
export const weatherConditions: { [key: number]: { description: string; iconUrl: string } | undefined } = {
  "200": {description: "Thunderstorms with light rainfall", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "201": {description: "Thunderstorms with rainfall", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "202": {description: "Thunderstorms with heavy rainfall", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "210": {description: "Light thunderstorms", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "211": {description: "Thunderstorms", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "212": {description: "Heavy thunderstorms", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "221": {description: "Ragged thunderstorms", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "230": {description: "Thunderstorms with light drizzle", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "231": {description: "Thunderstorms with drizzle", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "232": {description: "Thunderstorms with heavy drizzle", iconUrl: "https://openweathermap.org/img/wn/11d@2x.png"},
  "300": {description: "Light intensity drizzle", iconUrl: "https://openweathermap.org/img/wn/09d@2x.png"},
  "301": {description: "It's drizzling outside", iconUrl: "https://openweathermap.org/img/wn/09d@2x.png"},
  ...
  "311": {description: "It's Drizzling outside", iconUrl: "https://openweathermap.org/img/wn/09d@2x.png"},
  "312": {description: "Heavy intensity drizzle rain", iconUrl: "https://openweathermap.org/img/wn/09d@2x.png"},
  "500": {description: "Some light rain", iconUrl: "https://openweathermap.org/img/wn/10d@2x.png"},
  ...
  "701": {description: "It's misting right now", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "711": {description: "Smokey day", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "721": {description: "Hazey day", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "731": {description: "Sand, dust whirls", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "741": {description: "Foggy today", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "751": {description: "Sandy day", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  "761": {description: "It's dusty outside", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
  ...
  "800": {description: "Nice, clear sky's", iconUrl: "https://openweathermap.org/img/wn/01d@2x.png"},
  ...
  "960": {description: "Stormy day", iconUrl: "https://openweathermap.org/img/wn/50d@2x.png"},
